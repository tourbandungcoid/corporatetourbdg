...
const PUBLIC_ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/faq/budget", priority: 0.75, changeFrequency: "monthly" },
  { path: "/faq/logistics", priority: 0.7, changeFrequency: "monthly" },
  { path: "/faq/comparison", priority: 0.7, changeFrequency: "monthly" },
  { path: "/faq/formats", priority: 0.7, changeFrequency: "monthly" },
  { path: "/faq/location", priority: 0.75, changeFrequency: "monthly" },
  { path: "/faq/vendor", priority: 0.8, changeFrequency: "monthly" },
  { path: "/faq/outcome", priority: 0.75, changeFrequency: "monthly" },
