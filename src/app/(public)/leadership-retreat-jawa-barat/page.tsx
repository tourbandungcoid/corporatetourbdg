        ...
        <section className="py-14 bg-bone border-t border-divider">
          <div className="container-1280">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              {[["/panduan-corporate-outing-bandung", "Panduan Corporate Outing Bandung", "Master guide: jenis, budget, lokasi, vendor"], ["/event-organizer-corporate-bandung", "Event Organizer Corporate Bandung", "Specialist B2B untuk leadership event"], ["/executive-offsite-bandung", "Executive Offsite", "C-suite strategic offsite"], ["/incentive-trip-bandung", "Incentive Trip Bandung", "Program reward top performers"]].map(([href, title, desc]) => (
