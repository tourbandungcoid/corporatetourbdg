  ...
  return (
    <main>
      <PageHero
        ...
        description="Proposal lengkap sampai email lo dalam ≤24 jam (avg 6 jam saat working hours)."
      />
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="rounded-2xl border border-border bg-bone p-6 md:p-8">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <Link
                  href="/case-studies"
                  className="rounded-xl border border-border bg-paper px-5 py-4 hover:border-ink-soft transition flex items-center justify-between gap-3 group"
                >
                  <span className="text-sm font-medium text-ink">
                    Lihat case studies similar →
                  </span>
                  <ArrowRight
                    size={14}
