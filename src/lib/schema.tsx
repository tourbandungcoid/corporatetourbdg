...
export function organizationSchema() {
  return {
    ...
    review: [
      {
        "@type": "Review",
        author: { "@type": "Person", name: "Andini Pratama", jobTitle: "HR Manager", worksFor: { "@type": "Organization", name: "Tech Unicorn" } },
      ...
      {
        "@type": "Review",
        author: { "@type": "Person", name: "Bagas Wicaksono", jobTitle: "GA Manager", worksFor: { "@type": "Organization", name: "BUMN Bank" } },
        reviewBody: "Proposal-nya detailed breakdown — finance team gw approval cepet karena gak ada hidden cost yang muncul belakangan.",
        reviewRating: { "@type": "Rating", ratingValue: 5, bestRating: 5, worstRating: 1 },
        inLanguage: "id-ID",
        itemReviewed: { "@type": "Organization", "@id": `${SITE.url}#organization`, name: SITE.name },
      },
      {
        "@type": "Review",
        author: { "@type": "Person", name: "Citra Sari", jobTitle: "People Ops Lead", worksFor: { "@type": "Organization", name: "B2B SaaS Startup" } },
        reviewBody: "Custom 100%. Brief gw soal cross-team bonding pasca-merger, mereka kasih program yang bener-bener address itu — bukan template outing.",
        reviewRating: { "@type": "Rating", ratingValue: 5, bestRating: 5, worstRating: 1 },
        inLanguage: "id-ID",
        itemReviewed: { "@type": "Organization", "@id": `${SITE.url}#organization`, name: SITE.name },
      },
      {
        "@type": "Review",
        author: { "@type": "Person", name: "Fitri Hapsari", jobTitle: "HR Manager", worksFor: { "@type": "Organization", name: "Manufacturing MNC" } },
        reviewBody: "Vendor outing sebelumnya gak sanggup 600 pax. Mereka deliver 800 pax 3-day program tanpa miss detail. Skala mereka real.",
        reviewRating: { "@type": "Rating", ratingValue: 5, bestRating: 5, worstRating: 1 },
        inLanguage: "id-ID",
        itemReviewed: { "@type": "Organization", "@id": `${SITE.url}#organization`, name: SITE.name },
      },
    ...
    review: [
      {
        ...
        inLanguage: "id-ID",
        itemReviewed: { "@type": "LocalBusiness", "@id": `${SITE.url}#business`, name: SITE.name },
      },
      {
        "@type": "Review",
        reviewRating: { "@type": "Rating", ratingValue: 5, bestRating: 5, worstRating: 1 },
